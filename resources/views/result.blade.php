        ...
        <div class="col-4 offset-4">
            <div class="container text-centerborder rounded" style="background-color:cadetblue;">
                ...
                <div class="mt-4">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><strong>Nama:</strong> {{ $pasien}}</li>
                        <li class="list-group-item"><strong>Email:</strong> {{ $dokter }}</li>
                        <li class="list-group-item"><strong>Tanggal Lahir:</strong> {{ $status}}</li>
                        <li class="list-group-item"><strong>Skor:</strong> {{ $suhu}}</li>
